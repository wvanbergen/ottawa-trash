...
trash pickup schedule, to run correctly. You can build this database by issuing
two rake tasks.

    rake db:migrate # to setup the database schema.
    rake trash_schedule:scrape # to import the trash schedules for these streets.
